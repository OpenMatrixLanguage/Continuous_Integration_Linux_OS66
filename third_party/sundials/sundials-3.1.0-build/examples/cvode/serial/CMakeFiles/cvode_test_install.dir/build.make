...
examples/cvode/serial/CMakeFiles/cvode_test_install:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/users/banspach/oss/third_party_os66/sundials/sundials-3.1.0-build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running cvode installation tests"
	cd /users/banspach/oss/third_party_os66/sundials/sundials-3.1.0-build/Testing_Install/cvode && /soft/net/python /users/banspach/oss/third_party_os66/sundials/sundials-3.1.0/test/testRunner --testname=cvRoberts_dns --executablename=./cvRoberts_dns --outputdir=/users/banspach/oss/third_party_os66/sundials/sundials-3.1.0-build/Testing_Install/cvode --builddir=/users/banspach/oss/third_party_os66/sundials/sundials-3.1.0-install/examples/cvode/serial --buildcmd=/users/banspach/cmake/cmake-3.10.0-Linux-x86_64/bin/cmake --nodiff
...
examples/cvode/serial/CMakeFiles/cvode_test_install.dir/clean:
	cd /users/banspach/oss/third_party_os66/sundials/sundials-3.1.0-build/examples/cvode/serial && $(CMAKE_COMMAND) -P CMakeFiles/cvode_test_install.dir/cmake_clean.cmake
